...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,809,706,599],[0,1410,1204,349],[708,809,1204,349],[1206,1160,632,640],[0,0,1440,807]]},
		{name:"index_atlas_2", frames: [[1328,560,647,462],[661,0,665,499],[0,564,532,465],[1328,0,558,558],[661,501,665,462],[1176,1024,604,334],[0,0,659,562],[0,1031,327,169],[329,1031,172,74],[1888,138,96,39],[1782,1148,232,74],[329,1107,172,74],[1782,1024,202,122],[1888,179,96,39],[274,1202,232,74],[0,1202,272,122],[534,965,640,337],[1888,0,149,136]]}
];
...
// stage content:
(lib.pipelinev4 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.button_5).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.button_4).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.Popout_1},{t:this.Popup_1}]}).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.popup_2).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.popup_3).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.popup_4).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get(this.popup_5).wait(129));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},23).to({state:[]},2).to({state:[]},102).wait(2));
	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true,guide:{path:[187.7,68.3,355.7,68.8,523.8,69.3]}},23).wait(106));
	...
	this.instance_11.setTransform(478.95,186.5,0.5,0.5);

	this.instance_12 = new lib.CachedBmp_20();
	this.instance_12.setTransform(496.55,409.9,0.5,0.5);

	this.instance_13 = new lib.CachedBmp_19();
	this.instance_13.setTransform(473.45,276.75,0.5,0.5);

	this.instance_14 = new lib.CachedBmp_18();
	this.instance_14.setTransform(470.35,285.2,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]}).to({state:[{t:this.instance_10},{t:this.instance_14},{t:this.instance_8},{t:this.instance_7},{t:this.instance_13},{t:this.instance_12},{t:this.instance_4},{t:this.instance_11}]},128).wait(1));

	// dot_2
	this.instance_15 = new lib.Tween13("synched",0);
	this.instance_15.setTransform(520.35,84.45);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(33).to({x:520.3,y:68.9},0).to({guide:{path:[520.3,69,520.8,186.4,521.4,303.7,757.8,303.7,994.2,303.7]}},49).wait(47));

	// dot_4
	this.instance_16 = new lib.Tween17("synched",0);
	this.instance_16.setTransform(994.1,303.75);
	this.instance_16._off = true;

	this.instance_17 = new lib.Tween18("synched",0);
	this.instance_17.setTransform(517.7,418.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_16}]},83).to({state:[{t:this.instance_17}]},38).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(83).to({_off:false},0).to({_off:true,guide:{path:[994.1,303.7,994.1,361.2,994.1,418.7,755.9,418.7,517.7,418.7]}},38).wait(8));
...
p.nominalBounds = rect = new cjs.Rectangle(284.7,272,1440.3,669.7);
p.frameBounds = [rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect, rect];
// library properties:
lib.properties = {
